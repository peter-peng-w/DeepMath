...
# BASE_MODEL="/scratch/pw7nc/LLM_reasoning/off-policy-rl/replay-think/exp/qwen2.5-math-1.5b/math500/offline_grpo/lvl3to5_8k_20epochs_128effectbs/checkpoint-4000"
BASE_MODEL="/scratch/pw7nc/LLM_reasoning/off-policy-rl/replay-think/exp/qwen2.5-math-1.5b/math500/offline_grpo/lvl3to5_8k_20epochs_128effectbs/checkpoint-4960"
...
run_evaluation() {
    ...
    local model_name="qwen2.5-math-1.5b/math500/offline_grpo/lvl3to5_8k_20epochs_128effectbs/checkpoint-4960"
